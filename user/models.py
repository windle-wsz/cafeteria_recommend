...
class Rate(models.Model):
    cafeteria = models.ForeignKey(
        Cafeteria, on_delete=models.CASCADE, blank=True, null=True, verbose_name="餐厅id"
    )
...
class Comment(models.Model):
    ...
    cafeteria = models.ForeignKey(Cafeteria, on_delete=models.CASCADE, verbose_name="餐厅")
...
class Num(models.Model):
    ...
    cafeterias = models.IntegerField(verbose_name="餐厅数量", default=0)
